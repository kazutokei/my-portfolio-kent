      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            >
              {/* FIXED: Zoomed in (160%) and shifted down (-35%) to hide lower body */}
              <img
                className="w-[160%] max-w-none absolute left-1/2 bottom-[-35%] will-change-transform transition-transform duration-[120ms] ease-out"
                src={avatarUrl}
